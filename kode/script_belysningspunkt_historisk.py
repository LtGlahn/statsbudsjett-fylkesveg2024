...
if __name__ == '__main__': 
    ...
    # sok.filter( {'vegsystemreferanse' : 'Fv', 'tidspunkt' : '2022-09-22' } )                    # Fylkesveg  fase V = eksisterende  
    sok.filter( {  'tidspunkt' : '2022-09-22' } )                    # Fylkesveg  fase V = eksisterende  
    ...
    mydf.to_file( gpkgfil, layer='allebelysningspunkt_2', driver='GPKG'  )
